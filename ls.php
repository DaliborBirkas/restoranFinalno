        ...
        <br>
            ...
            if(isset($_SESSION['userUid'])){
                ...
                echo '   <form method="post" action="insert.php" >
                                ...
                                <label for="start" style="color:white;font-size: 18px;">Select date if you are creating reservation  </label>&nbsp;&nbsp;&nbsp;

                            <input type="date" id="start" name="date" min='.$dateee.'  max="2021-12-31"><br>
                            
                              <label for="start1" style="color:white;font-size: 18px;">Select date if you are updating reservation</label>&nbsp;&nbsp;&nbsp;

                            <input type="date" id="start1" name="date2" min='.$dateee.' max="2021-12-31"><br>
                            
                            
                             <label for="vremeP" style=" font-size: 18px; color: white">Start hour(if you are creating reservation)  </label>  
                              <select name="vremeP" id="vremeP"><br>
                                 ...
                                 <label for="vremeP" style=" font-size: 18px; color: white">New Start hour (if you are updating reservation)</label>  
                                ...
                                <br>
                        <label   style="color: white;font-size: 18px;">How long do you want to be in the restaraunt?  ( min 1h, max 6h ) </label><br>
                              ...
                              <br>   <label for="sto" style="margin-left: 70px; color: white;font-size: 18px" >Choose table</label><br>
                               
                                 ';

            /*    echo'
                                  <select name="sto" id="vremeT">
                                  <option value="">...</option>
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
