...
$base_url = "https://wwbasify.proj.vts.su.ac.rs/ProjekatFinalno/confirm.php?email=$email&token=$token";
$mail_body = "
<p>Hi " . $_POST['uid'] . ",</p>
...
$mail->setFrom('destroyer1000lp@gmail.com', "$uname");
...
$mail->Password='XXXXX';
$mail->SMTPSecure='ssl';
$mail->From="dbirkas3@gmail.com";
$mail->FromName="Nistanovo";
